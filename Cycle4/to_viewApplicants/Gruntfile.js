  ...
  grunt.initConfig({
    ...
    */
    neuter: {
      ...
      '/Volumes/s3.amazonaws.com/toprototype1/Cycle4/to_viewApplicants.pck.js': 'app/to_viewApplicants_compiler.js'
    },
    ...
    */
    watch: {
      application_code: {
        files: ['app/*.js', '../to_talentProfileCommon/*.js'],
        tasks: ['neuter']
      },
     ...
     // }
     handlebars_templates: {
        files: ['../to_talentProfileCommon/**/*.hbs'],
    ...
    ember_templates: {
      options: {
        templateName: function(sourceFile) {
          return sourceFile.replace(/..\/to_talentProfileCommon\/templates\//, '');
        }
      },
      //'dependencies/compiled/templates.js': ["app/templates/**/*.hbs"]
      '../to_talentProfileCommon/templates.js': ["../to_talentProfileCommon/templates/**/*.hbs"]
    },

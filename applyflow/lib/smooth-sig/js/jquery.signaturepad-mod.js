    ...
    */
    ...
    for (k = 0; k < sections.length; k++) {
      ...
      for (var i in beziers) {
        ...
        // Checking to make sure p0, p1, p2 and p3 exist. This is a fix so the plugin works in VF pages.
        if (typeof p0 !== 'undefined' && typeof p1 !== 'undefined' && typeof p2 !== 'undefined' && typeof p3 !== 'undefined'){
          context.beginPath()
